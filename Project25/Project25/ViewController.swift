...
//  Project25
//
//  Created by JEONGSEOB HONG on 2021/09/01.
//
...
class ViewController: UICollectionViewController {
    ...
    func startHosting(action: UIAlertAction) {
        ...
        mcAdvertiserAssistant = MCAdvertiserAssistant(serviceType: "hws-project",
                                                      discoveryInfo: nil,
                                                      session: mcSession)
    ...
    func joinSession(action: UIAlertAction) {
        guard let mcSession = mcSession else { return }
        let mcBrowser = MCBrowserViewController(serviceType: "hws-project",
                                                session: mcSession)
...
extension ViewController: MCSessionDelegate, MCBrowserViewControllerDelegate {
    ...
    // important! main working function
